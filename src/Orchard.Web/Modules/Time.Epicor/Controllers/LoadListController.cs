...
namespace Time.Epicor.Controllers
{
    ...
    public class LoadListController : Controller
    {
        ...
        public ActionResult AsmInspect(string sortOrder, AsmInspectViewModel vm = null)
        {
            ...
            ViewBag.ShipDateUp = "shipdate_sortup";
            ViewBag.ShipDateDown = "shipdate_sortdown";
            ViewBag.MakeReadyCheck = "makeready_sortcheck";
            ViewBag.MakeReadyNot = "makeready_sortnot";
            ViewBag.NameUp = "name_sortup";
            ViewBag.NameDown = "name_sortdown";
            ViewBag.SerialUp = "serial_sortup";
            ViewBag.SerialDown = "serial_sortdown";
            ViewBag.JobUp = "job_sortup";
            ViewBag.JobDown = "job_sortdown";
            ViewBag.LiftUp = "lift_sortup";
            ViewBag.LiftDown = "lift_sortdown";
            ViewBag.ClaimedCheck = "claimed_sortcheck";
            ViewBag.ClaimedNot = "claimed_sortnot";
            ViewBag.RTCheck = "rt_sortcheck";
            ViewBag.RTNot = "rt_sortnot";
            ViewBag.TestCheck = "test_sortcheck";
            ViewBag.TestNot = "test_sortnot";
            ViewBag.BlueCheck = "blue_sortcheck";
            ViewBag.BlueNot = "blue_sortnot";
            ViewBag.BoxCheck = "box_sortcheck";
            ViewBag.BoxNot = "box_sortnot";
            ViewBag.ShipCheck = "ship_sortcheck";
            ViewBag.ShipNot = "ship_sortnot";
            ViewBag.PedCheck = "ped_sortcheck";
            ViewBag.PedNot = "ped_sortnot";
            ViewBag.ORCheck = "or_sortcheck";
            ViewBag.ORNot = "or_sortnot";
            ViewBag.BuktCheck = "bukt_sortcheck";
            ViewBag.BuktNot = "bukt_sortnot";
            ViewBag.GreenCheck = "green_sortcheck";
            ViewBag.GreenNot = "green_sortnot";
            ViewBag.LShipCheck = "lship_sortcheck";
            ViewBag.LShipNot = "lship_sortnot";

            switch (sortOrder)
            {
                case "shipdate_sortup":
                    jobs = jobs.OrderBy(x => x.LoadList.DateSchedShip);
                    break;
                case "shipdate_sortdown":
                    jobs = jobs.OrderBy(x => x.LoadList.DateSchedShip == null).ThenByDescending(x => x.LoadList.DateSchedShip);
                    break;
                case "makeready_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.LoadList.MakeReady);
                    break;
                case "makeready_sortnot":
                    jobs = jobs.OrderBy(x => x.LoadList.MakeReady);
                    break;
                case "name_sortup":
                    jobs = jobs.OrderBy(x => x.CustomerName);
                    break;
                case "name_sortdown":
                    jobs = jobs.OrderByDescending(x => x.CustomerName);
                    break;
                case "serial_sortup":
                    jobs = jobs.OrderBy(x => x.SerialNo);
                    break;
                case "serial_sortdown":
                    jobs = jobs.OrderByDescending(x => x.SerialNo);
                    break;
                case "job_sortup":
                    jobs = jobs.OrderBy(x => x.JobNumber);
                    break;
                case "job_sortdown":
                    jobs = jobs.OrderByDescending(x => x.JobNumber);
                    break;
                case "lift_sortup":
                    jobs = jobs.OrderBy(x => x.LiftModel);
                    break;
                case "lift_sortdown":
                    jobs = jobs.OrderByDescending(x => x.LiftModel);
                    break;
                case "claimed_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Claimed);
                    break;
                case "claimed_sortnot":
                    jobs = jobs.OrderBy(x => x.Claimed);
                    break;
                case "rt_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.ReadyToTest);
                    break;
                case "rt_sortnot":
                    jobs = jobs.OrderBy(x => x.ReadyToTest);
                    break;
                case "test_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Tested);
                    break;
                case "test_sortnot":
                    jobs = jobs.OrderBy(x => x.Tested);
                    break;
                case "blue_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Blue);
                    break;
                case "blue_sortnot":
                    jobs = jobs.OrderBy(x => x.Blue);
                    break;
                case "box_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Box);
                    break;
                case "box_sortnot":
                    jobs = jobs.OrderBy(x => x.Box);
                    break;
                case "ship_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Ship);
                    break;
                case "ship_sortnot":
                    jobs = jobs.OrderBy(x => x.Ship);
                    break;
                case "ped_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Ped);
                    break;
                case "ped_sortnot":
                    jobs = jobs.OrderBy(x => x.Ped);
                    break;
                case "or_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.OutRigger);
                    break;
                case "or_sortnot":
                    jobs = jobs.OrderBy(x => x.OutRigger);
                    break;
                case "bukt_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Bucket);
                    break;
                case "bukt_sortnot":
                    jobs = jobs.OrderBy(x => x.Bucket);
                    break;
                case "green_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.Green);
                    break;
                case "green_sortnot":
                    jobs = jobs.OrderBy(x => x.Green);
                    break;
                case "lship_sortcheck":
                    jobs = jobs.OrderByDescending(x => x.LShip);
                    break;
                case "lship_sortnot":
                    jobs = jobs.OrderBy(x => x.LShip);
                    break;
                default:
